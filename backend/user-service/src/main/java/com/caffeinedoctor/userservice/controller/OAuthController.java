...
import com.caffeinedoctor.userservice.service.OAuthUserService;
...
public class OAuthController {
    ...
    private final OAuthUserService kakaoOAuthService;
...
//            "사용자 정보를 이용하여 서비스에 회원가입합니다.")
    public ResponseEntity<String> kakaoCallback(@RequestParam("code") String code) {
        ...
        // Kakao 사용자 정보 요청
        String userInfo = kakaoOAuthService.requestKakaoUserInfo(accessToken);
